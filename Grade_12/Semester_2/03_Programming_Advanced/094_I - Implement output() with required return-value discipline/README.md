# I94 — Implement output() with required return-value discipline
...
- Implement output() with required return-value discipline
...
Student can apply implement output() with required return-value discipline.

## 2️⃣ Minimum Evidence

Independently completes a task involving implement output() with required return-value discipline without reference materials.
