# I93 — Implement read() and compute() with correct parameter passing
...
- Implement read() and compute() with correct parameter passing
...
Student can apply implement read() and compute() with correct parameter passing.

## 2️⃣ Minimum Evidence

Independently completes a task involving implement read() and compute() with correct parameter passing without reference materials.
