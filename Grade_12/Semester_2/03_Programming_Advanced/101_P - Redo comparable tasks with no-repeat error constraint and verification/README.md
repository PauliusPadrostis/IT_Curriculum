# P101 — Redo comparable tasks with "no-repeat error" constraint and verification
...
- Redo comparable tasks with "no-repeat error" constraint and verification
...
Student can produce redo comparable tasks with "no-repeat error" constraint and verification.

## 2️⃣ Minimum Evidence

Produces a correct and complete solution demonstrating redo comparable tasks with "no-repeat error" constraint and verification under timed conditions.
