# I70 — Search algorithm choice: sorted vs unsorted reasoning with justification
...
- Search algorithm choice: sorted vs unsorted reasoning with justification
...
Student can apply search algorithm choice: sorted vs unsorted reasoning with justification.

## 2️⃣ Minimum Evidence

Independently completes a task involving search algorithm choice: sorted vs unsorted reasoning with justification without reference materials.
