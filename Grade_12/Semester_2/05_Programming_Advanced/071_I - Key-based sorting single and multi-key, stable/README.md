# I69 — Key-based sorting: single and multi-key, stable sort reasoning
...
- Key-based sorting: single and multi-key, stable sort reasoning
...
Student can apply key-based sorting: single and multi-key, stable sort reasoning.

## 2️⃣ Minimum Evidence

Independently completes a task involving key-based sorting: single and multi-key, stable sort reasoning without reference materials.
