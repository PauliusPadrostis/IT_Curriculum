# I94 — Full composition review: correctness, edge cases, output specification
...
**Parent topic:** I21–I24 (4) — Workflow 6: Two-part composition
**Status:** 🚧 WIP
...
- Full composition review: correctness, edge cases, output specification
...
Student can apply full composition review: correctness, edge cases, output specification.

## 2️⃣ Minimum Evidence

Independently completes a task involving full composition review: correctness, edge cases, output specification without reference materials.
