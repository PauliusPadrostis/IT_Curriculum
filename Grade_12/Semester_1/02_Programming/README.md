...
| # | Folder | Type |
|---|--------|------|
| 030 | `030_L - Parsing a task statement into inputs → outputs/` | 📖 Lesson |
| 031 | `031_L - Output formatting exact spec compliance/` | 📖 Lesson |
...
| 043 | `043_I - Formatted output assembly exact spec/` | 🔗 Integration practice |
| 044 | `044_P - Timed drill file reading and exact-format/` | 🏃 Practice exam |
...
| 057 | `057_L - Unit-level reasoning what each function guarantees/` | 📖 Lesson |
| 058 | `058_I - Multi-criteria record selection filter by two/` | 🔗 Integration practice |
| 059 | `059_I - Aggregation over selected records sum, count/` | 🔗 Integration practice |
| 060 | `060_I - Sorted and formatted report output ordered/` | 🔗 Integration practice |
| 061 | `061_I - Full workflow integration read → filter/` | 🔗 Integration practice |
| 062 | `062_P - Timed record filtering with deliberate edge/` | 🏃 Practice exam |
| 063 | `063_P - Timed correctness drill edge case traps under/` | 🏃 Practice exam |
| 064 | `064_A - Practical assessment composite structure/` | 📝 Assessment |
| 065 | `065_A - Report output formatting and correctness/` | 📝 Assessment |
