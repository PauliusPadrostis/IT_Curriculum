# L31 — Output formatting: exact spec compliance
...
Student can explain output formatting: exact spec compliance.

## 2️⃣ Minimum Evidence

Correctly explains output formatting: exact spec compliance in own words or in response to targeted questions without reference.
