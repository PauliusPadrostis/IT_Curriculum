...
- When generating Lithuanian, load the shared mistake library at `~/.claude/skills/_shared/lt-mistakes.yaml` before writing. Skills are user-global (`~/.claude/skills/`), not in this repo; the library is self-updating.
