...
4. `.Codex/skills/assessment-task-gen/references/question_design.md` — MCQ rules, short answer rules, code task hierarchy
5. `.Codex/skills/assessment-task-gen/references/testmoz_format.md` — Testmoz .xlsx import specification and pool structure
6. `.Codex/skills/student-task-gen/references/task_format.md` — student-facing document formatting baseline
...
### Cross-skill references
- `.Codex/skills/assessment-task-gen/references/question_design.md` — MCQ rules, short answer rules, code task hierarchy, variant generation
- `.Codex/skills/assessment-task-gen/references/testmoz_format.md` — Testmoz .xlsx import specification and pool structure
- `.Codex/skills/student-task-gen/references/task_format.md` — student-facing document formatting baseline
