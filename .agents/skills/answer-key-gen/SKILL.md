...
4. `.Codex/skills/assessment-task-gen/references/grading_policy.md` — percentage scale (cross-skill read)
5. `.Codex/skills/assessment-task-gen/references/cs_assessment_progression.md` — grade expectations (cross-skill read)
...
**Note on paths:** Items 1-3 use paths relative to this skill's directory (`.Codex/skills/answer-key-gen/`). Items 4-5 use sibling skill paths. Items 6-7 use repo-root paths.
