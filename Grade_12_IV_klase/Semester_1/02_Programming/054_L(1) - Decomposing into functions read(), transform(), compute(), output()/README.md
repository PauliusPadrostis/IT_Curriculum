# L54 (1) — Decomposing into functions: read(), transform(), compute(), output()
...
Student can explain decomposing into functions: read(), transform(), compute(), output().

## 2️⃣ Minimum Evidence

Correctly explains decomposing into functions: read(), transform(), compute(), output() in own words or in response to targeted questions without reference.
