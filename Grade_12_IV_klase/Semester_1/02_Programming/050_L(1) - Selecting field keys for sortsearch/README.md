# L50 (1) — Selecting field keys for sort/search
...
Student can explain selecting field keys for sort/search.

## 2️⃣ Minimum Evidence

Correctly explains selecting field keys for sort/search in own words or in response to targeted questions without reference.
