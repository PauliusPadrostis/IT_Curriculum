# L33 (1) — Specification Reading + I/O Discipline (Foundation) — Part 4
...
Student can explain specification reading + i/o discipline (foundation) — part 4.

## 2️⃣ Minimum Evidence

Correctly explains specification reading + i/o discipline (foundation) — part 4 in own words or in response to targeted questions without reference.
