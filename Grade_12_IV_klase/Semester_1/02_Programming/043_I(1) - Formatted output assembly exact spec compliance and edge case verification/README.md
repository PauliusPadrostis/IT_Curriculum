# I43 (1) — Formatted output assembly: exact spec compliance and edge case verification
...
- Formatted output assembly: exact spec compliance and edge case verification
...
Student can apply formatted output assembly: exact spec compliance and edge case verification.

## 2️⃣ Minimum Evidence

Independently completes a task involving formatted output assembly: exact spec compliance and edge case verification without reference materials.
