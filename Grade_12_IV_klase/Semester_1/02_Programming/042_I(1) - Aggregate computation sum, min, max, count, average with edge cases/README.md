# I42 (1) — Aggregate computation: sum, min, max, count, average with edge cases
...
- Aggregate computation: sum, min, max, count, average with edge cases
...
Student can apply aggregate computation: sum, min, max, count, average with edge cases.

## 2️⃣ Minimum Evidence

Independently completes a task involving aggregate computation: sum, min, max, count, average with edge cases without reference materials.
