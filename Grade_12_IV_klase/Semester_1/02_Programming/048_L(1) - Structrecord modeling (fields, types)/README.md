# L48 (1) — Struct/record modeling (fields, types)
...
Student can explain struct/record modeling (fields, types).

## 2️⃣ Minimum Evidence

Correctly explains struct/record modeling (fields, types) in own words or in response to targeted questions without reference.
