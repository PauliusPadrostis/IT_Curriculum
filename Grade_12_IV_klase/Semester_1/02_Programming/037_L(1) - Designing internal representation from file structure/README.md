# L37 (1) — Designing internal representation from file structure
...
Student can explain designing internal representation from file structure.

## 2️⃣ Minimum Evidence

Correctly explains designing internal representation from file structure in own words or in response to targeted questions without reference.
