# I41 (1) — Data cleaning: strip whitespace, validate types, handle missing values
...
- Data cleaning: strip whitespace, validate types, handle missing values
...
Student can apply data cleaning: strip whitespace, validate types, handle missing values.

## 2️⃣ Minimum Evidence

Independently completes a task involving data cleaning: strip whitespace, validate types, handle missing values without reference materials.
