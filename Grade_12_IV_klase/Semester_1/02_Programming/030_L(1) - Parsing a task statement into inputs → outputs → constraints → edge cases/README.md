# L30 (1) — Parsing a task statement into: inputs → outputs → constraints → edge cases
...
**Lessons allocated:** 1
**Parent topic:** L1–L4 (4) – Specification Reading + I/O Discipline (Foundation)
**Status:** 🚧 WIP
...
Student can explain parsing a task statement into: inputs → outputs → constraints → edge cases.

## 2️⃣ Minimum Evidence

Correctly explains parsing a task statement into: inputs → outputs → constraints → edge cases in own words or in response to targeted questions without reference.
