# D127 (1) — Data error clinic: wrong grouping level, incorrect aggregation, misleading chart, unsupported conclusion
...
- Data error clinic: wrong grouping level, incorrect aggregation, misleading chart, unsupported conclusion
...
Student can diagnose data error clinic: wrong grouping level, incorrect aggregation, misleading chart, unsupported conclusion.

## 2️⃣ Minimum Evidence

Demonstrates corrected understanding of data error clinic: wrong grouping level, incorrect aggregation, misleading chart, unsupported conclusion on a comparable redo task.
