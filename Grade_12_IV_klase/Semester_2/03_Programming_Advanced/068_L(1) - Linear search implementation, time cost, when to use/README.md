# L68 (1) — Linear search: implementation, time cost, when to use
...
- Linear search: implementation, time cost, when to use
...
Student can explain linear search: implementation, time cost, when to use.

## 2️⃣ Minimum Evidence

Correctly explains linear search: implementation, time cost, when to use in own words or in response to targeted questions without reference.
