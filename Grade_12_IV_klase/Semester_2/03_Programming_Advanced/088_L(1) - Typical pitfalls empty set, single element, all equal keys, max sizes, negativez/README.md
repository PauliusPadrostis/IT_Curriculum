# L88 (1) — Typical pitfalls: empty set, single element, all equal keys, max sizes, negative/zero

**Type:** 📖 Lesson
**Grade:** Grade 12 (IV gimnazijos klasė)
**Module:** Programming – Sort/Search, Modular & Robustness
**Semester:** Semester 2
**Sequence:** 88 of grade year
**Lessons allocated:** 1
...
Student can explain typical pitfalls: empty set, single element, all equal keys, max sizes, negative/zero.

## 2️⃣ Minimum Evidence

Correctly explains typical pitfalls: empty set, single element, all equal keys, max sizes, negative/zero in own words or in response to targeted questions without reference.
