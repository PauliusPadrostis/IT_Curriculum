# L66 (1) — Sorting algorithms: selection, insertion, bubble — logic and step-by-step tracing
...
- Sorting algorithms: selection, insertion, bubble — logic and step-by-step tracing
...
Student can explain sorting algorithms: selection, insertion, bubble — logic and step-by-step tracing.

## 2️⃣ Minimum Evidence

Correctly explains sorting algorithms: selection, insertion, bubble — logic and step-by-step tracing in own words or in response to targeted questions without reference.
