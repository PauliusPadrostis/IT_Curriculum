# I75 (1) — Output specification enforcement: exact format, edge cases, completeness
...
- Output specification enforcement: exact format, edge cases, completeness
...
Student can apply output specification enforcement: exact format, edge cases, completeness.

## 2️⃣ Minimum Evidence

Independently completes a task involving output specification enforcement: exact format, edge cases, completeness without reference materials.
