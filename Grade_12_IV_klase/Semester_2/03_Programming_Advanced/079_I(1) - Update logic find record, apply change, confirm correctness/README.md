# I79 (1) — Update logic: find record, apply change, confirm correctness
...
- Update logic: find record, apply change, confirm correctness
...
Student can apply update logic: find record, apply change, confirm correctness.

## 2️⃣ Minimum Evidence

Independently completes a task involving update logic: find record, apply change, confirm correctness without reference materials.
