# I96 (1) — Build an intermediate data structure from raw input
...
- Build an intermediate data structure from raw input
...
Student can apply build an intermediate data structure from raw input.

## 2️⃣ Minimum Evidence

Independently completes a task involving build an intermediate data structure from raw input without reference materials.
