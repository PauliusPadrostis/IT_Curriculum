# I94 (1) — Sort and search arrays: correctness focus, output format enforced
...
- Sort and search arrays: correctness focus, output format enforced
...
Student can apply sort and search arrays: correctness focus, output format enforced.

## 2️⃣ Minimum Evidence

Independently completes a task involving sort and search arrays: correctness focus, output format enforced without reference materials.
