# I95 (1) — Aggregate operations on arrays: sum, count, min, max, average
...
- Aggregate operations on arrays: sum, count, min, max, average
...
Student can apply aggregate operations on arrays: sum, count, min, max, average.

## 2️⃣ Minimum Evidence

Independently completes a task involving aggregate operations on arrays: sum, count, min, max, average without reference materials.
