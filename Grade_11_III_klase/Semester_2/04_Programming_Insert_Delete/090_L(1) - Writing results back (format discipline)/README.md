# L90 (1) — Writing results back (format discipline)
...
Student can explain writing results back (format discipline).

## 2️⃣ Minimum Evidence

Correctly explains writing results back (format discipline) in own words or in response to targeted questions without reference.
