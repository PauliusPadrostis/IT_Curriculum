...
**Modulio būsena:** 3/7 ✅ Failai sukurti (laukia patikros), 4/7 🚧 WIP

## Lesson Index

| # | Folder | Type | Būsena |
|---|--------|------|--------|
| 001 | `001_L - Ergonomics & healthy computer use/` | 📖 Lesson | ✅ Failai sukurti |
| 002 | `002_L - Privacy & account safety/` | 📖 Lesson | 🚧 WIP |
| 003 | `003_L - Online risks & safe response logic/` | 📖 Lesson | 🚧 WIP |
| 004 | `004_L - Environmental impact of digital technologies/` | 📖 Lesson | 🚧 WIP |
