# Specialisation: Digital Printing
...
> **Teacher note:** Students choose EITHER this track OR Website Design.

## Lesson Index

| # | Folder | Type |
|---|--------|------|
| 023 | `023_L - Page layout principles (margins, grid logic)/` | 📖 Lesson |
| 024 | `024_L - Typography basics/` | 📖 Lesson |
| 025 | `025_L - Working with images in layout/` | 📖 Lesson |
...
| 033 | `033_A - Practical print layout submission/` | 📝 Assessment |
