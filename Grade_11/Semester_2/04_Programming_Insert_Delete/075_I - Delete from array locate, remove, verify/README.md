# I75 — Delete from array: locate, remove, verify remaining data integrity
...
- Delete from array: locate, remove, verify remaining data integrity
...
Student can apply delete from array: locate, remove, verify remaining data integrity.

## 2️⃣ Minimum Evidence

Independently completes a task involving delete from array: locate, remove, verify remaining data integrity without reference materials.
