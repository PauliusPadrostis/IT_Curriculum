# I84 — Update element: find, replace, confirm recomputed metrics
...
- Update element: find, replace, confirm recomputed metrics
...
Student can apply update element: find, replace, confirm recomputed metrics.

## 2️⃣ Minimum Evidence

Independently completes a task involving update element: find, replace, confirm recomputed metrics without reference materials.
