# L49 — Comparisons and normalization (case, spaces)
...
Student can explain comparisons and normalization (case, spaces).

## 2️⃣ Minimum Evidence

Correctly explains comparisons and normalization (case, spaces) in own words or in response to targeted questions without reference.
