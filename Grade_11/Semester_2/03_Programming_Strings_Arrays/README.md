...
| # | Folder | Type |
|---|--------|------|
| 047 | `047_L - Indexing, slicing, traversal patterns/` | 📖 Lesson |
...
| 061 | `061_I - Error patterns off-by-one, type mismatch/` | 🔗 Integration practice |
| 062 | `062_P - Output prediction and dry-run table drills/` | 🏃 Practice exam |
| 063 | `063_P - Error type identification and code tracing/` | 🏃 Practice exam |
| 064 | `064_A - Practical assessment file-driven algorithm task/` | 📝 Assessment |
