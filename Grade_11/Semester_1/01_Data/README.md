...
| 004 | `004_F - Formative check/` | 📌 Formative check |
...
| 012 | `012_L - “Analysis-ready table” criteria/` | 📖 Lesson |
| 013 | `013_F - Formative check/` | 📌 Formative check |
| 014 | `014_I - Join two datasets identify matching keys/` | 🔗 Integration practice |
| 015 | `015_I - Pivot basics construct a pivot from joined/` | 🔗 Integration practice |
...
| 023 | `023_F - Formative check/` | 📌 Formative check |
| 024 | `024_I - What does this query return - VBE 1 style/` | 🔗 Integration practice |
| 025 | `025_I - What does this query return - VBE 1 style/` | 🔗 Integration practice |
| 026 | `026_I - Choose the correct query and explain why/` | 🔗 Integration practice |
| 027 | `027_P - Timed mixed mini-set (data lifecycle)/` | 🏃 Practice exam |
| 028 | `028_A - Query reasoning/` | 📝 Assessment |
